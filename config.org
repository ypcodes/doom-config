...
(setq! doom-font (font-spec :family "FiraCode Nerd Font" :size 22  :weight 'semi-light)
      ...
      doom-unicode-font (font-spec :family "Symbola" :size 22)
      )
#+end_src
...
(add-hook 'after-init-hook 'pretty-mode)
#+end_src
** rainbow mode
#+begin_src emacs-lisp :tangle yes
...
(map! :desc "Screenshot fullscreen"
      :g "<print>" 'screenshot-full
      :g "S-<print>" 'screenshot-select
      :g "C-<print>" 'screenshot-current-window
      )
)
#+end_src
*** Window Class
...
+ My blog homepage:
  [[https://blog.yemouren.com/][宿云间 — 君不见周南歌汉广，天教夫子休乔木]]
