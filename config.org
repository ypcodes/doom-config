...
veterans who want less framework in their frameworks, a modicum of stability (and
reproducibility) from their package manager, and the performance of a hand rolled
config (or better). It can be a foundation for your own config or a resource for
...
- [[#intro][Intro]]
  ...
  - [[#why-emacs][Why Emacs?]]
  - [[#select-a-framwork][Select a framwork]]
- [[#screenshot][Screenshot]]
- [[#install][Install]]
  - [[#install-emacs][Install emacs]]
  - [[#install-doom-emacs][Install Doom Emacs]]
  - [[#install-my-configfile][Install My Configfile]]
- [[#basic-configuration][Basic Configuration]]
  - [[#lexical-binding][Lexical Binding]]
  - [[#exit-emacs-without-confirm][Exit emacs without confirm]]
  - [[#startup-performace][Startup Performace]]
  - [[#input-method][Input Method]]
  - [[#user-name-and-email][User name and email]]
  - [[#fullscreen-when-start][Fullscreen when start]]
  - [[#customel][~custom.el~]]
...
- [[#packages][Packages]]
  ...
  - [[#all-the-icons-rich][all-the-icons-rich]]
  - [[#evil][evil]]
  - [[#format-on-save][format on save]]
  - [[#laas][laas]]
  - [[#emcas-rime][emcas-rime]]
  - [[#vterm][vterm]]
...
- [[#system][System]]
  - [[#commands][Commands]]
  - [[#re-tangle-codes][Re-tangle codes]]
  - [[#envirement-varibles][Envirement varibles]]
  - [[#startup-tools][Startup tools]]
- [[#exwm][EXWM]]
  - [[#install-1][Install]]
  - [[#configration][Configration]]
  - [[#start-exwm][Start Exwm]]
  ...
  (setq org-super-agenda-groups
        '(;; Each group has an implicit boolean OR operator between its selectors.
          ...
          (:priority<= "B"
           ...
           :order 1))))
(add-to-list 'org-agenda-files "/home/yp/org/agenda/todo.org" 'append)
(add-to-list 'org-agenda-files "/home/yp/org/agenda/courses.org" 'append)
#+end_src
*** org media note
#+begin_src emacs-lisp :tangle packages.el
...
(use-package! appt
  ...
  (setq appt-message-warning-time 15) ; Show notification 5 minutes before event
  ...
  (add-hook 'after-save-hook
            '(lambda ()
               (if (string= (buffer-file-name) (concat (getenv "HOME")
                                                       "/org/agenda/todo.org"))
                   (my-org-agenda-to-appt))))
  (add-hook 'after-save-hook
            '(lambda ()
...
Set PATH
#+begin_src emacs-lisp :tangle yes
(setenv "PATH" (concat (getenv "PATH") ":" (concat (getenv "HOME") "/.emacs.d/bin")))
#+end_src
